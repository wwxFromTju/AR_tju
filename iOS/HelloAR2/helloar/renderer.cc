...
//        "    gl_FragColor = vcolor;\n"
        "    gl_FragColor =   vec4(0.8,0.5,0.5,1) + vec4(0.3,0.2,0.5 ,1) * vcolor;\n"
        "}\n"
        "\n"
;
...
//    
    ...
    glBufferData ( GL_ARRAY_BUFFER, sizeof ( tjuround1Verts ),
                tjuround1Verts, GL_STATIC_DRAW );
    glBindBuffer ( GL_ARRAY_BUFFER, vboIds[1] );
    glBufferData ( GL_ARRAY_BUFFER, sizeof ( tjuround1Normals ),
                  tjuround1Normals, GL_STATIC_DRAW );
    glBindBuffer ( GL_ARRAY_BUFFER, vboIds[2] );
    glBufferData ( GL_ARRAY_BUFFER, sizeof ( tjuround1TexCoords ),
                  tjuround1TexCoords, GL_STATIC_DRAW );
...
//     glUniform1i ( samplerLoc, 0 );
    ...
    glDrawArrays(GL_TRIANGLES, 0,tjuround1NumVerts);
